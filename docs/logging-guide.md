...
**Train model pace** học độ thay đổi thời gian vòng kế tiếp. **Train model lốp** tạo hai mô hình nghiên cứu dự đoán thay đổi độ mòn và nhiệt độ lõi lốp tại lần lấy mẫu qua vạch kế tiếp, khi có đủ log đã xác nhận. Mục tiêu thiếu nhãn hoặc tín hiệu wear không dùng được sẽ được đánh dấu bỏ qua trong báo cáo, không tạo model giả. Các mô hình này chưa tự chọn **vòng pit tối ưu**: việc đó cần nhãn chiến thuật hoặc phương pháp đánh giá những phương án không diễn ra trong cuộc đua.
